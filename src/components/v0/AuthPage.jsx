  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full py-3 bg-primary text-white rounded-xl font-medium transition-colors hover:bg-primary/90 disabled:bg-primary/50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      >
        {isLoading && (
      ...
      <div>
        <div className={`flex items-center border rounded-xl px-4 py-3 transition-colors ${
          ...
          <button
            ...
            className="text-sm text-primary disabled:text-gray-400 whitespace-nowrap"
          >
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pt-8 pb-12">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">UniShop</h1>
          <p className="text-sm text-gray-500 mt-1">发现好物，品质生活</p>
        </div>
